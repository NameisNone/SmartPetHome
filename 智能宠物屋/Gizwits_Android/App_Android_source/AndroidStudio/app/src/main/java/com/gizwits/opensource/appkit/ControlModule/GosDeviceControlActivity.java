...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private Switch sw_bool_ultraviolet_LED;
	private Switch sw_bool_Light_LED;
	private Switch sw_bool_MusicSwitch;
	private Switch sw_bool_WhiteLight;
	private Spinner sp_enum_HH;
	private Spinner sp_enum_MM;
	...
	private void initView() {
		...
		sw_bool_ultraviolet_LED = (Switch) findViewById(R.id.sw_bool_ultraviolet_LED);
		sw_bool_Light_LED = (Switch) findViewById(R.id.sw_bool_Light_LED);
		sw_bool_MusicSwitch = (Switch) findViewById(R.id.sw_bool_MusicSwitch);
		sw_bool_WhiteLight = (Switch) findViewById(R.id.sw_bool_WhiteLight);
		sp_enum_HH = (Spinner) findViewById(R.id.sp_enum_HH);
		sp_enum_MM = (Spinner) findViewById(R.id.sp_enum_MM);
	...
	private void initEvent() {
		...
		sw_bool_ultraviolet_LED.setOnClickListener(this);
		sw_bool_Light_LED.setOnClickListener(this);
		sw_bool_MusicSwitch.setOnClickListener(this);
		sw_bool_WhiteLight.setOnClickListener(this);
		sp_enum_HH.setSelection(0, false);
		sp_enum_HH.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_HH) {
					sendCommand(KEY_HH, position);
					data_HH = position;
				}
			}
		...
		sp_enum_MM.setSelection(0, false);
		sp_enum_MM.setOnItemSelectedListener(new OnItemSelectedListener() {

			@Override
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

				if (position != data_MM) {
					sendCommand(KEY_MM, position);
					data_MM = position;
				}
			}
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.sw_bool_ultraviolet_LED:
			sendCommand(KEY_ULTRAVIOLET_LED, sw_bool_ultraviolet_LED.isChecked());
			break;
		case R.id.sw_bool_Light_LED:
			sendCommand(KEY_LIGHT_LED, sw_bool_Light_LED.isChecked());
			break;
		case R.id.sw_bool_MusicSwitch:
			sendCommand(KEY_MUSICSWITCH, sw_bool_MusicSwitch.isChecked());
			break;
		case R.id.sw_bool_WhiteLight:
			sendCommand(KEY_WHITELIGHT, sw_bool_WhiteLight.isChecked());
			break;
		default:
			break;
		}
	...
	protected void updateUI() {
		...
		sw_bool_ultraviolet_LED.setChecked(data_ultraviolet_LED);
		sw_bool_Light_LED.setChecked(data_Light_LED);
		sw_bool_MusicSwitch.setChecked(data_MusicSwitch);
		sw_bool_WhiteLight.setChecked(data_WhiteLight);
		sp_enum_HH.setSelection(data_HH, true);
		sp_enum_MM.setSelection(data_MM, true);
