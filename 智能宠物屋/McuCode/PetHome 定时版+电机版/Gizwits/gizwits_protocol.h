...
* @{
*/
#define PRODUCT_KEY "da03f6a1555b4e12ba09ffbafbd60e94"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "d1e87900e84548ccb0e23b5ccf6b16dc"
...
* @{
*/
#define ultraviolet_LED_BYTEOFFSET                    0
#define ultraviolet_LED_BITOFFSET                     0
#define ultraviolet_LED_LEN                           1
#define Light_LED_BYTEOFFSET                    0
#define Light_LED_BITOFFSET                     1
#define Light_LED_LEN                           1
#define MusicSwitch_BYTEOFFSET                    0
#define MusicSwitch_BITOFFSET                     2
#define MusicSwitch_LEN                           1
#define WhiteLight_BYTEOFFSET                    0
#define WhiteLight_BITOFFSET                     3
#define WhiteLight_LEN                           1
#define DoorMotor_BYTEOFFSET                    0
#define DoorMotor_BITOFFSET                     4
#define DoorMotor_LEN                           1
#define HH_BYTEOFFSET                    0
#define HH_BITOFFSET                     5
#define HH_LEN                           5
#define MM_BYTEOFFSET                    1
#define MM_BITOFFSET                     10
#define MM_LEN                           6
...
typedef struct {
  bool valueultraviolet_LED;
  bool valueLight_LED;
  bool valueMusicSwitch;
  bool valueWhiteLight;
  bool valueDoorMotor;
  uint32_t valueHH;
  uint32_t valueMM;
...
typedef struct {
  uint8_t flagultraviolet_LED:1;
  uint8_t flagLight_LED:1;
  uint8_t flagMusicSwitch:1;
  uint8_t flagWhiteLight:1;
  uint8_t flagDoorMotor:1;
  uint8_t flagHH:1;
  uint8_t flagMM:1;
} attrFlags_t;
