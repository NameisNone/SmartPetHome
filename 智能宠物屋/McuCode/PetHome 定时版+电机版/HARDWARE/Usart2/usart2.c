...
void uart2_init(void)
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART2,ENABLE); //我太难了，时钟都没开 Fuck！！
...
void uart3_init(void)
{
  ...
  RCC_APB1PeriphClockCmd(RCC_APB1Periph_USART3,ENABLE); //我太难了，时钟都没开 Fuck！！
